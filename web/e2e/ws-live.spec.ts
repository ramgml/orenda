...
test.describe('WebSocket live update (cookie auth, Phase 27.2)', () => {
  test('after agent submit, /today awaiting banner updates via real WS push', async ({ page }) => {
    ...
    await expect(page.getByText(/awaiting your review/)).not.toHaveText(bannerBefore, {
      timeout: 10_000,
    });
