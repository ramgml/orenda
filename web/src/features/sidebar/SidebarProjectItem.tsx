    ...
    <div
      className={`group relative flex items-center gap-2 rounded px-2 py-1.5 text-sm ${
        active
          ...
          : 'text-foreground dark:text-foreground hover:bg-slate-100 dark:hover:bg-slate-800'
      }`}
    >
      ...
      >
        ...
        {isSystem && (
          <span
            className="text-[9px] uppercase tracking-wide px-1 py-0.5 rounded bg-slate-200 dark:bg-slate-700 text-muted-foreground dark:text-muted-foreground shrink-0"
      ...
      <span
        className="text-[11px] tabular-nums text-muted-foreground dark:text-muted-foreground min-w-[1.25rem] text-right shrink-0"
