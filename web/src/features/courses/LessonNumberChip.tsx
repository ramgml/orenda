...
/**
 * Human-readable lesson number chip (`L10`).
 *
 * Click copies `L10` to the clipboard and briefly swaps the label to
 ...
 */
export function LessonNumberChip({ number }: { number: number }): JSX.Element | null {
  ...
  return (
    <span
      role="button"
      tabIndex={0}
      data-testid="lesson-number-chip"
      onClick={(e) => {
        e.stopPropagation();
        copy();
      }}
