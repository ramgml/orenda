...
function SortableLessonRow(props: {
  ...
  return (
    <li
      ...
      className={`space-y-1 rounded bg-muted dark:bg-muted p-2 ${isDragging ? 'opacity-50' : ''}`}
    >
      ...
      <Textarea
        ...
        className="text-xs"
      />
      <div className="pl-2 border-l border dark:border-border">
...
function SortableModuleRow(props: { m: EditorModule; h: RowHandlers }): JSX.Element {
  ...
  return (
    <li
      ...
      className={`rounded border border-border p-3 bg-background dark:bg-background space-y-2 ${isDragging ? 'opacity-50' : ''}`}
    >
      <div className="flex gap-2">
        <button
          type="button"
