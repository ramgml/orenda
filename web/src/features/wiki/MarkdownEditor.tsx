...
export function MarkdownEditor({
  ...
  if (!editor) {
    return (
      <div className="rounded border border-border bg-muted dark:bg-muted p-6 text-sm text-slate-500">
        Loading editor…
      </div>
    );
  }
  ...
  return (
    <div className="rounded border border-border bg-background dark:bg-background overflow-hidden">
      <BubbleMenu
        editor={editor}
        className="flex items-center gap-0.5 rounded-md border border dark:border-border bg-card shadow-lg px-1 py-0.5 text-xs"
      >
        <Btn
