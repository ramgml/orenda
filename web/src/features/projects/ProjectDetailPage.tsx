    ...
    <section>
      <div className="flex items-center justify-between mb-4 gap-4">
        <h1 className="text-2xl font-semibold flex items-center gap-2 min-w-0">
          ...
          {project?.archived && (
            <span className="text-xs uppercase tracking-wide text-slate-500 border border dark:border-border rounded px-2 py-1 flex-shrink-0">
              archived
            </span>
          )}
        </h1>
        {project?.wiki_slug && (
          <a
            ...
            className="text-xs px-2 py-1 rounded border border dark:border-border hover:bg-slate-100 dark:hover:bg-slate-800 flex-shrink-0"
    ...
    return (
      <span className="inline-flex flex-col gap-1 min-w-0 flex-1">
        <Input
          ...
          className="text-2xl font-semibold px-2 py-1 rounded border border-orenda-500 bg-background dark:bg-background outline-none min-w-0"
        />
