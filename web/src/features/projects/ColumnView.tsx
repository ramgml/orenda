...
export function ColumnView({
  ...
  return (
    <div
      ref={setNodeRef}
      className={`rounded-lg border bg-muted dark:bg-muted p-3 flex flex-col min-h-[200px] transition-colors ${
        isOver
        ...
        <div className="flex items-center gap-2">
          ...
          */}
          <span
            ...
            className="inline-block w-2.5 h-2.5 rounded-full border border-border/60 dark:border-border/60"
            style={{ backgroundColor: color || '#94a3b8' }}
          />
          <h2 className="font-medium text-sm uppercase tracking-wide text-muted-foreground dark:text-muted-foreground">
            {name}
          </h2>
        </div>
        <div className="flex items-center gap-2">
        ...
        <form onSubmit={submit} className="space-y-2">
          ...
          <label className="block text-sm">
            ...
            <input
              ...
              className="mt-1 block w-12 h-8 rounded border border dark:border-border bg-transparent"
            />
          </label>
          <label className="block text-sm">
