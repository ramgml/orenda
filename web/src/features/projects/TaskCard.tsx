...
export function TaskCard({
  ...
  return (
    <div
      ...
      className={`w-full min-w-0 rounded border border-l-4 border dark:border-border bg-background dark:bg-background p-2 text-sm cursor-grab select-none ${priorityBorder} ${
