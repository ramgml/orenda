...
> Живая копия — wiki:release-process в dogfood-инстансе (конвенция `docs/context/DOGFOOD.md`). Этот файл — снапшот процесса в репо; при расхождении правит wiki, а расхождение устраняется при ближайшем релизе.
>
