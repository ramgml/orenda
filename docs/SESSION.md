...
- **Дата:** 2026-08-13
- **Ветка:** `dev`
- **Статус:** смержено: фазы 0–26 + Wave 4 (down-миграции + minor 🟡 close-out) + 27.1–27.5. Открыты: 27.6 (worktree), 27.7–27.10. Теги `v0.1.0-phase0` … `v0.1.0-wave4-minor`.
- **Worktrees в работе:** `phase-27-6-courses-manual` (manual fill — почти готов к PR), `phase-22-ui-restore`, `phase-telegram-onboarding` и др. — см. `git worktree list`.
...
- **Курсы: ручное наполнение (Phase 27.6)** — ✅ **закрыто в worktree `phase-27-6-courses-manual`** — см. секцию выше.
