...
- [~] **30.14** — в работе: MiniMax-M3, branch `phase-30-14-bulk-edit`, с 2026-08-16. **Phase 27.7/27.8 за скобкой: UI статусов проекта + bulk-edit.** Добавление/переименование статус-колонок с выбором machine key; массовые операции над задачами (status/assignee/priority).
