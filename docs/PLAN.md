...
- [~] **30.10** — в работе: opencode/k3, branch `phase-30-10-quickcapture-due`, с 2026-08-16. **Phase 21: due-поле в QuickCapture.** В 21.1 планировалось «опционально due»; в модалке только title (`QuickCapture.tsx`, один input). Приёмка: due сохраняется в задачу; хоткей-флоу не замедлен (поле опционально, таб-навигация).
