-- ============================================================================
-- 039_lesson_numbers.down.sql — drop the human-readable lesson numbers
-- ============================================================================
...
DROP INDEX IF EXISTS idx_lessons_number;
DROP TABLE IF EXISTS lesson_number_seq;
ALTER TABLE course_lessons DROP COLUMN number;
