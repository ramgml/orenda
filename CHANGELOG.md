...
- **PR #189:** back-merge of `release-v0.18.0` into `dev` after the v0.18.0 release — the mandatory step from `docs/GITFLOW.md` «Release-цикл» was skipped for every release since v0.2.0; this folds the VERSION/CHANGELOG release-prep commits back so `dev` carries them.
